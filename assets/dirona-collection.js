(function () {
  var layout = document.querySelector('[data-dirona-shop-layout]');
  var toggle = document.querySelector('[data-dirona-filter-toggle]');
  var checkbox = document.querySelector('[data-dirona-filter-checkbox]');
  ...
  function openFilterGroups() {
    document.querySelectorAll('.dirona-facets .facets__disclosure-vertical').forEach(function (details) {
      details.open = true;
    });
  }
