...
class CartItems extends window.StandardEvents.createViewEventElement(HTMLElement) {
  ...
  onCartUpdate() {
    if (this.tagName === 'CART-DRAWER-ITEMS') {
      ...
      const sectionId = cartItemsEl?.dataset.id || 'main-cart-items';
  ...
  getSectionsToRender() {
    ...
    const cartPageHead = document.getElementById('cart-page-head');
    ...
    if (sectionId && cartPageHead) {
      sections.push({
        id: 'cart-page-head',
        section: sectionId,
        selector: '#cart-page-head .js-contents',
      });
    }
    ...
    if (mainCartFooter) {
      sections.push({
        id: 'main-cart-footer',
        section: mainCartFooter.dataset.id || sectionId,
